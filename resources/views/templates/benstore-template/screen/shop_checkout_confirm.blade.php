                ...
                <form class="sc-shipping-address" id="form-order" role="form" method="POST" action="{{ sc_route('order.add') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <h3 class="control-label"><i class="linearicons-home"></i>
                            ...
                            <table class="table box table-bordered" id="showTotal">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $shippingAddress['province'].' '.$shippingAddress['district'].' '.$shippingAddress['ward'].','.$shippingAddress['address'] }}
                                    </td>
                                </tr>
                                ...
                                <div class="col-md-12 text-center">
                                    <div class="pull-left">
                                        <button class="button button-lg" type="button"
                                            style="cursor: pointer;outline:none;padding:10px 30px"
                                            onClick="location.href='{{ sc_route('cart') }}'">{{ sc_language_render('cart.back_to_cart') }}</button>
                                    </div>
                                    <div class="pull-right">
                                        <button class="button button-lg button-primary" id="submit-order" type="submit"
                                            style="cursor: pointer;padding:10px 30px">{{ sc_language_render('cart.confirm') }}</button>
                                    </div>
                                </div>
                            </div>
                            {{--// Button process cart --}}
