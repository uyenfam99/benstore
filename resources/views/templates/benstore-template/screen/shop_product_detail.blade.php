...
{{-- <link rel="stylesheet" href="{{ asset($sc_templateFile.'/css/style_old.css')}}"> --}}
            ...
            <form id="buy_block" class="product-information" action="{{ sc_route('cart.add') }}" method="post">
              ...
              <div class="single-product">
                ...
                <div class="group-xs group-middle">
                    ...
                    <div>
                        <button class="button button-lg button-primary button-zakaria" type="submit">{{ sc_language_render('action.add_to_cart') }}</button>
                    </div>
                </div>
                @endif
                {{--// Button add to cart --}}
...
@push('scripts')
{{-- //script here --}}
<script src="{{ asset($sc_templateFile.'/js/core_old.min.js')}}"></script>
    
<script src="{{ asset($sc_templateFile.'/js/script_old.js')}}"></script>
@endpush
