...
<head>
    ...
    <link rel="icon" href="{{ sc_file(sc_store('icon', null, 'images/favicon.ico')) }}" type="image/png" sizes="16x16">
    ...
    <link rel="stylesheet" href="{{ sc_file($sc_templateFile.'/css/slick-theme.css')}}">
    <link rel="stylesheet" href="{{ sc_file($sc_templateFile.'/css/style.css')}}">
    <link rel="stylesheet" href="{{ sc_file($sc_templateFile.'/css/style_main.css')}}">
    <style>
        {!! sc_store_css() !!}
    </style>
    <style>
...
<body>
    ...
    <script src="{{ sc_file($sc_templateFile.'./js/jquery-3.6.0.js')}}"></script>
    <script src="{{ sc_file($sc_templateFile.'./js/slick.min.js')}}"></script> 
    <script src="{{ sc_file($sc_templateFile.'./js/slide.js')}}"></script>
    <script src="{{ sc_file($sc_templateFile.'./js/xzoom.min.js')}}"></script>
